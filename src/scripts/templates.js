...
export function generateReportDetailTemplate({
  ...
  const imagesHtml = generateReportDetailImageTemplate(evidenceImages, reporterName);
  console.log(imagesHtml)

  return `
    <div class="report-detail__header">
      <h1 id="title" class="report-detail__title">${reporterName}</h1>
    ...
    <div class="container">
      <div class="report-detail__body">
        <div class="report-detail__body__description__container">
          <h2 class="report-detail__description__title">Detail Story</h2>
